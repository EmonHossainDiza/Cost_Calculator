                    ...
                    <div class="row" id="main">
                        <div class="col-sm-12 col-md-offset-3 col-md-6 col-md-offset-right-3 well" id="content">
                            ...
                            <div class="col-sm-12 col-md-12 well_profile_edit_input " >
                                <form class="form-group" action="{{url('/password_changed')}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <input type="password" class="form-control loguname" name="pass" placeholder="Password"  >
                                    <input type="password" class="form-control loguname" name="con_pass" placeholder="Confirm Password"  >
